...
import { createtaskstep1,createTaskHeaderVisible } from '../../../../../Redux/Slice/ManageTaskSlice';
import { useDispatch,useSelector } from 'react-redux';
function PracticeHome() {
  const step1CreateTask=useSelector((state)=>state.managetasks.setView)
  ...
  return (
    ...
    <div className='flex items-center gap-[20px]'>
            <button className='flex   items-center gap-[10px] p-[10px] boxshadow rounded-[10px]' onClick={()=>{dispatch(createtaskstep1()); dispatch(createTaskHeaderVisible())}}>
